...
function fetchProducts($conn) {
    $stmt = $conn->prepare("SELECT p.name, p.price, p.image FROM products p WHERE p.category_id = 1");
    $stmt->execute();
...
<head>
    ...
    <title>Seeds - Farming Store</title>
    <style>
        body {
        ...
        <table>
            ...
            <?php foreach ($products as $product): ?>
                <tr>
                    ...
                    <td>
                        <form action="shop-seeds.php" method="get" style="display:inline;">
