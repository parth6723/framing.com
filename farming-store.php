...
function fetchProducts($conn) {
    $stmt = $conn->prepare("SELECT p.name, p.price, p.image, c.category_name FROM products p JOIN categories c ON p.category_id = c.id");
    $stmt->execute();
        ...
        <table>
            ...
            <?php foreach ($products as $product): ?>
                <tr>
                    ...
                    <td>
                        <form action="buy-now.php" method="get" style="display:inline;">
