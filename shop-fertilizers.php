...
function fetchProducts($conn) {
    $stmt = $conn->prepare("SELECT p.name, p.price, p.image FROM products p WHERE p.category_id = 3"); 
    $stmt->execute();
...
<head>
    ...
    <title>Fertilizers - Farming Store</title>
    <style>
        body {
...
<body>
    <header>
        <h1>Farming Store - Fertilizers</h1>
        <nav>
        ...
        <table>
            ...
            <?php foreach ($products as $product): ?>
                <tr>
                    ...
                    <td>
                        <form action="shop-fertilizers.php" method="get" style="display:inline;">
